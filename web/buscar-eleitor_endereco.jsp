            ...
            <div class="content-wrapper">
                <div class="box">
                    <div class="box-header">
                        <h2 class="box-title">Buscar Usuário por Endereço</h2>
                    ...
                    <div class="box-body">
                        ...
                        <form data-toggle="validator"   method="get" acceptcharset="UTF-8" action="buscar-eleitor_endereco.jsp">
                            <div class="row">
                                <!-- coluna um inicil  -->                            
                                ...
                                <div class="form-group">
                                    <div class="col-md-10 input-group">
                                        ...
                                        <input id="end" name="end" placeholder="" class="form-control small" required="" type="text">
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                ...
                <div class="box">
                    ...
                    <div class="box-body">
                        <h2> Resultado da Busca por Endereço</h2>
